        ...
        <div class="hero-right">
          <div class="cotacao-card" v-if="!cotacaoEnviada">
            ...
            <div class="cotacao-body">
              <v-text-field v-model="empresa" label="Sua empresa" variant="outlined" density="compact" color="#E8821A" bg-color="white" class="mb-2" />
              <div class="form-row">
                <v-text-field v-model="origem" label="Origem (cidade)" variant="outlined" density="compact" color="#E8821A" bg-color="white" />
                <v-text-field v-model="destino" label="Destino (cidade)" variant="outlined" density="compact" color="#E8821A" bg-color="white" />
              </div>
              <div class="form-row">
                <v-select v-model="tipoCarga" :items="tiposCarga" label="Tipo de carga" variant="outlined" density="compact" color="#E8821A" bg-color="white" />
                <v-text-field v-model="peso" label="Peso (kg)" variant="outlined" density="compact" color="#E8821A" bg-color="white" type="number" />
              </div>
...
const empresa = ref(''); const origem = ref(''); const destino = ref('')
const tipoCarga = ref(''); const peso = ref(''); const whatsapp = ref('')
...
function novaCotacao() {
  empresa.value=''; origem.value=''; destino.value=''
  tipoCarga.value=''; peso.value=''; whatsapp.value=''
...
.hero-side-bar {
  ...
  background: linear-gradient(180deg, #E8821A 0%, #FF9A2E 50%, #E8821A 100%);
}
.hero-inner {
...
.cotacao-header { display: flex; align-items: center; gap: 10px; background: #F8F8F8; padding: 14px 20px; font-size: 13px; font-weight: 700; color: #0C1A3E; border-bottom: 1px solid #EBEBEB; font-family: 'Barlow', 'Inter', sans-serif; letter-spacing: 0.02em; text-transform: uppercase; }
.cotacao-body { padding: 20px; }
